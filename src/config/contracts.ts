...
export const CONTRACTS: Record<string, ContractAddresses> = {
  ...
  testnet: {
    ...
    USDC_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_USDC || '0x0000000000000000000000000000000000000000',
  ...
  mainnet: {
    ...
    USDC_ADDR: process.env.NEXT_PUBLIC_CONTRACT_MAINNET_USDC || '0x0000000000000000000000000000000000000000',
    SANCTION_ORACLE_ADDR: process.env.NEXT_PUBLIC_CONTRACT_MAINNET_SANCTION_ORACLE || '0x0000000000000000000000000000000000000000',
    USDC_WHALE: process.env.NEXT_PUBLIC_CONTRACT_MAINNET_USDC_WHALE || '0x0000000000000000000000000000000000000000',
  },
};
