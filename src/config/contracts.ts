 ...
 * @LastEditTime: 2025-08-21 21:07:53
...
// 本地开发使用主网USDC地址 (需要fork主网或部署mock合约)
...
// Sepolia测试网USDC地址 (USDC在Sepolia上的地址)
const SEPOLIA_USDC_ADDR = '0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238' // Sepolia USDC
...
export const CONTRACTS: Record<string, ContractAddresses> = {
  ...
  // 测试网环境 (Sepolia)
  testnet: {
    KYC_ORACLE_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_KYC_ORACLE || '0x0000000000000000000000000000000000000000',
    PROPERTY_ORACLE_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_PROPERTY_ORACLE || '0x0000000000000000000000000000000000000000',
    RENT_TOKEN_IMPL_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_RENT_TOKEN_IMPL || '0x0000000000000000000000000000000000000000',
    SERIES_FACTORY_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_SERIES_FACTORY || '0x0000000000000000000000000000000000000000',
    USDC_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_USDC || SEPOLIA_USDC_ADDR, // 默认使用Sepolia USDC
    SANCTION_ORACLE_ADDR: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_SANCTION_ORACLE || '0x0000000000000000000000000000000000000000',
    USDC_WHALE: process.env.NEXT_PUBLIC_CONTRACT_TESTNET_USDC_WHALE || '0x0000000000000000000000000000000000000000',
  },
  ...
  mainnet: {
    ...
    USDC_WHALE: process.env.NEXT_PUBLIC_CONTRACT_MAINNET_USDC_WHALE || '0x55fe002aeff02f77364de339a1292923a15844b8',
  },
};
